...
class FinishGoodsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        FinishGoods::create([
            ...
            'boxes' => $request->boxes,
            'order_purchase_date' => Carbon::parse($request->order_purchase_date)->toDateString(),
            'good_details' => $request->good_details,
            'company' => $request->company,
            'description_of_goods' => $request->description_of_goods,
            'qty_in_storage_start' => $request->qty_in_storage_start,
            'qty_issued' => $request->qty_issued,
            'qty_in_storage_end' => $request->qty_in_storage_end,
            'qty_returned' => $request->qty_returned,
            'wastage' => $request->wastage,
            'actual_qty_consumed' => $request->actual_qty_consumed,
        ]);
